...
prompt_base=prompt/complex/complex_base_aqua.txt
prompt_hint=prompt/complex/complex_PHP_aqua.txt
...
prompt_base=prompt/complex/complex_base_gsm8k.txt
prompt_hint=prompt/complex/complex_PHP_gsm8k.txt
