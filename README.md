...
## News
- [05/02/2023]: We achieve the SOTA performance 54.0% on MATH dataset, which is the currently most challenging reasoning dataset! We will update our paper and the code soon!!!
